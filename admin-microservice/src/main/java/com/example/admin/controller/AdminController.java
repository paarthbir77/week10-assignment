...
public class AdminController {
	...
	@ResponseBody
	public String saveFinReport(@RequestParam("username")  String username,@RequestParam("bill") int bill,@RequestParam("date") String date,@RequestParam("month") String month,@RequestParam("year") String year) {
		FinancialReport financialreport = adminService.saveFinReport(username, bill, date, month, year);
