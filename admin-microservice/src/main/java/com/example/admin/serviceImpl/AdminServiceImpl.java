...
public class AdminServiceImpl implements AdminService {
	...
	@Override
	public FinancialReport saveFinReport(String username, int bill, String date, String month, String year) {
		FinancialReport finReport = new FinancialReport(username, bill, date, month, year);
